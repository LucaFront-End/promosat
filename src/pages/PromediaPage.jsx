...
export default function PromediaPage() {
  ...
  useEffect(() => {
    ...
    // Simple staggered entrance — no ScrollTrigger (avoids blank page bug)
    ...
    <div className="promedia-page" ref={pageRef}>
      ...
      <section className="pm-section pm-why">
        <div className="container">
          ...
          <h2 className="pm-section__title">El futuro del audio</h2>
          <div className="pm-why__layout">
            <div className="pm-why__reasons">
              {promediaContent.whyPodcasting.map((r, i) => (
      ...
      <section className="pm-section pm-production">
        <div className="container">
          ...
          <div className="pm-prod__grid">
            {promediaContent.services.slice(0, 6).map((s, i) => (
              <div key={i} className="pm-prod-item">
                <div className="pm-prod-item__icon"><span>{String(i + 1).padStart(2, '0')}</span></div>
                <div>
                  <div className="pm-prod-item__title">{s}</div>
                  <div className="pm-prod-item__desc">Servicio profesional de alto impacto.</div>
                </div>
              </div>
            ))}
          </div>
            ...
            {promediaContent.podcasts.map((p, i) => (
              <div key={i} className="pm-podcast-card">
                ...
                <div className="pm-podcast-card__stats">
                  <div className="pm-podcast-stat">
                    <span className="pm-podcast-stat__val">{p.episodes}</span>
                    <span className="pm-podcast-stat__key">Episodios</span>
                  </div>
                  <div className="pm-podcast-stat">
                    <span className="pm-podcast-stat__val">{p.frequency}</span>
                    <span className="pm-podcast-stat__key">Frecuencia</span>
                  </div>
                </div>
