    ...
    <div className="contact-page" ref={heroRef}>
      ...
      <section className="cp-hero">
        ...
        <div className="cp-hero__content container">
          <span className="tag tag--accent"><span className="tag__dot" /> CONTACTO</span>
          <h1 className="cp-hero__title">Hablemos de tu<br /><span>próxima campaña</span></h1>
          <p className="cp-hero__sub">Nuestro equipo de expertos está listo para ayudarte a conectar con millones de oyentes.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="cp-grid">
            ...
            <div className="cp-card cp-form-card">
              <h2 className="cp-card__title">Envíanos un mensaje</h2>
              <form className="cp-form" onSubmit={handleSubmit}>
                <div className="cp-form__row">
                  <div className="cp-form__field">
                    <label>Nombre *</label>
                    <input type="text" name="name" value={formData.name} onChange={handleChange} required placeholder="Tu nombre completo" />
                  </div>
                  <div className="cp-form__field">
                    <label>Email *</label>
                ...
                <div className="cp-form__row">
                  <div className="cp-form__field">
                    ...
                    <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+52 ___-___-____" />
                  </div>
                  <div className="cp-form__field">
                    <label>Empresa</label>
                    <input type="text" name="company" value={formData.company} onChange={handleChange} placeholder="Tu empresa" />
                  </div>
                </div>
                <div className="cp-form__field">
                  <label>Mensaje *</label>
                  <textarea name="message" value={formData.message} onChange={handleChange} required rows="5" placeholder="¿En qué podemos ayudarte?" />
                </div>
            ...
            <div className="cp-sidebar">
              <div className="cp-card cp-info-card">
                <h3>Contacto directo</h3>
                <a href={`tel:${siteConfig.phone}`} className="cp-info__link">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
                  {siteConfig.phone}
                </a>
                <a href={`mailto:${siteConfig.email}`} className="cp-info__link">
                ...
                <a href={siteConfig.whatsapp} target="_blank" rel="noopener noreferrer" className="cp-info__link cp-info__link--wa">
              ...
              {offices.map((office, i) => (
                <div key={i} className="cp-card cp-office-card">
                  ...
                  <h3>{office.name}</h3>
                  <p>{office.address}</p>
                  <a href={office.mapLink} target="_blank" rel="noopener noreferrer" className="cp-office__map">
