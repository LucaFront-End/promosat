      ...
      <div className="pinned-showcase__container container">
        ...
        <div className="pinned-showcase__left">
          <div className="pinned-showcase__content">
            ...
            <h2 className="heading-xl" style={{ marginTop: '1rem', marginBottom: '1.5rem' }}>Una Empresa de<br/><span style={{color: 'var(--color-accent)'}}>Grupo Promomedios</span></h2>
...
function ShowcaseCard({ company, index }) {
  return (
    <div className="showcase-card">
      ...
      <div className="showcase-card__socials">
        {company.social && Object.entries(company.social).map(([platform, url], j) => (
          <a key={j} href={url} className="social-pill" target="_blank" rel="noopener noreferrer">
            {platform === 'linkedin' && (
